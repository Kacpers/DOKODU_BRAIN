...
owner: kacper
created: 2026-03-29
tags: [sprzedaz, outreach, linkedin, tracker]
---

# Outreach Tracker — LinkedIn Prospecting

> Aktualizowany przez skill `/outreach`. Status: `zaproszenie` → `zaakceptowane` → `dm` → `odpowiedź` → `call` → `propozycja` → `wygrana/przegrana`
...
| 6a | Volkswagen FS | Kamil Rychłowski | IT Project Manager | A | 2026-04-01 | zaproszenie_wysłane | Czekaj na akceptację → DM (wdrożenie) | 2026-04-04 |
| 6b | Volkswagen FS | Dominika Kobylarz | IT PM – Data & Analytics | A | 2026-04-01 | zaproszenie_wysłane | Czekaj na akceptację → DM (wdrożenie) | 2026-04-04 |
...
| Firma | Stanowisko z ogłoszenia | Score | Oferta |
|-------|------------------------|-------|--------|
| Volkswagen FS Polska | Starszy Specjalista ds. AI i Automatyzacji | A | W+SZ |
| CUK Ubezpieczenia | Specjalista ds. Automatyzacji Procesów | A | A+SZ |
| Grupa PZU | Menedżer ds. AI i Technologii Chmurowych | A | W+SZ |
| Scania Polska | Specjalista ds. Automatyzacji Procesów Serwisowych | A | A+SZ |
| ENEA Centrum | Starszy Specjalista ds. Automatyzacji i Robotyzacji | A | A+SZ |
| Miele Global Services | Senior O2C Process Improvement | A | A+SZ |
| CLIMATIC sp. z o.o. | Lider ds. Procesów i Automatyzacji IT | A | A+SZ |
| VeloBank S.A. | Zespół Zwiększania Efektywności Operacyjnej | A | A+SZ |
| Empik S.A. | Senior Marketing Automation Specialist | A | SZ+W |
| Inter Cars | PowerPlatform Automation Developer | A | SZ+W |
| **Arbiter S.A.** *(nowy 30.03)* | Microsoft Automation Specialist | A | SZ+W |
| **NIVEA Polska** *(nowy 30.03)* | Sales Controller | A | A+SZ |
| SPIE Building Solutions *(nowy 30.03)* | Analityk biznesowy / RPA | B | A |

## Statystyki

| Metryka | Wartość |
|---------|---------|
| Zaproszenia wysłane | 0 |
| Zaakceptowane | 0 |
| DM wysłane | 0 |
| Odpowiedzi | 0 |
| Calle umówione | 0 |
| Konwersja zaproszenie→akceptacja | —% |
| Konwersja DM→odpowiedź | —% |

---

*Aktualizuj po każdej sesji `/outreach`*
